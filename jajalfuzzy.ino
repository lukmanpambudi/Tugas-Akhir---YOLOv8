...
FuzzySet *RightPelan = new FuzzySet(0, 5, 35, 40);
FuzzySet *RightSedang = new FuzzySet(35, 40, 60, 65);
FuzzySet *RightCepat = new FuzzySet(60, 65, 75, 80);

// Output membership function (kecepatan motor kiri)
FuzzySet *LeftPelan = new FuzzySet(0, 5, 35, 40);
FuzzySet *LeftSedang = new FuzzySet(35, 40, 60, 65);
FuzzySet *LeftCepat = new FuzzySet(60, 65, 75, 80);
    ...
    if (elapsedTime >= sampleTime) {
      ...
      if (Serial.available() > 0) {
        ...
        if (receivedData.startsWith("error_")) {
          ...
          if (output1 >= 65 && output2 >= 0 && output2 <= 40) { // BelokKiriTajam
            Serial.println("Belok Kiri Tajam");
            pwmValueKanan = 75; // Kecepatan motor kanan tinggi
            pwmValueKiri = 25; // Kecepatan motor kiri sedang
          ...
          } else if (output1 >= 40 && output1 <= 65 && output2 >= 0 && output2 <= 40) { // BelokKiri
            Serial.println("Belok Kiri");
            pwmValueKanan = 55; // Kecepatan motor kanan sedang
            pwmValueKiri = 15; // Kecepatan motor kiri pelan
            Serial.print("PWM Kanan: ");
            Serial.print(pwmValueKanan);
            Serial.print("PWM Kiri: ");
            Serial.println(pwmValueKiri);
          ...
          } else if (output1 >= 40 && output1 <= 65 && output2 >= 40 && output2 <= 65) { // MajuLurus
          ...
          } else if (output1 >= 0 && output1 <= 40 && output2 >= 40 && output2 <= 65) { // BelokKanan
            Serial.println("Belok Kanan");
            pwmValueKanan = 15; // Kecepatan motor kanan pelan
            pwmValueKiri = 55; // Kecepatan motor kiri sedang
            Serial.print("PWM Kanan: ");
            Serial.print(pwmValueKanan);
            Serial.print("PWM Kiri: ");
            Serial.println(pwmValueKiri);
          ...
          } else if (output1 >= 0 && output1 <= 40 && output2 >= 65) { // BelokKananTajam
            Serial.println("Belok Kanan Tajam");
            pwmValueKanan = 25; // Kecepatan motor kanan sedang
            pwmValueKiri = 75; // Kecepatan motor kiri tinggi
            Serial.print("PWM Kanan: ");
            Serial.print(pwmValueKanan);
            Serial.print("PWM Kiri: ");
            Serial.println(pwmValueKiri);
